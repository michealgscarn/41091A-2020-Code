...
//----------Goal 2 (Left Wall)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(24, 48, 0, 2);   //Move to line up with next ball while spinning to face it
...
//----------Goal 8 (Front wall)----------//
  ...
  setLift(127);   //Start running lift
  DriveCoordShort(75,48,-475,1.5); //Pick up ball
  pros::delay(550);   //Wait for ball to score
  setIntake(0);
...
DriveCoordShort(127,22,-587,2);   //Back away from goal
}
