...
// Set the velocity of the Lift using the Controller.//
 void setLiftMotor(){
   int power = 60 * controller.get_digital(DIGITAL_R1) + !controller.get_digital(DIGITAL_R1)*(127 * (controller.get_digital(DIGITAL_R2) + controller.get_digital(DIGITAL_L1) - (controller.get_digital(DIGITAL_L2) ) ) ); // Set lift velocity based on button presses
