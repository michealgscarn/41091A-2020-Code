...
void a_SKILLS_BROKEN_ARM_DISTANCE_FILTER_115(){
// ---------- PREPARE THE PROGRAM ---------- //
...
// ---------- Goal 2 (Left Wall) ---------- //
  // ----- Transition to Goal ----- //
  DriveCoordShort(49, 42, 8, 3);   //Move to line up with next ball while spinning to face it
...
// ---------- Goal 5 (Back Right Corner) ---------- //
  // ----- Transition to Goal ----- //
  DriveCoordShort(71.6,115,0,0.9); //Back away from goal
  setIntake(127);    //Run intake in reverse
  setDelivery(-127);   //Stop running delivery
...
// ---------- Goal 8 (Center) ---------- //
  ...
  DriveCoordShort(93,74,274,0.55);   //Back away
  //
   //DriveCoordShort(84.5,74,274,0.65);    //Drive in front of goal
   //DriveCoordShort(93,74,274,0.65);   //Back away
  //
  //DriveCoordShort(84.5,75,274,0.55);    //Drive in front of goal
  //DriveCoordShort(95.8,73.1,277,0.55);   //Back away
  ...
  setIntake(0);
  DriveCoordShort(81.6,70,314,1);   //Drive into goal
...
// ---------- Goal 9 (Front Wall) ---------- //
  ...
  DriveCoordShort(93,55,269,0.85);    //Turn to face ball
