...
// ---------- Goal 5 (Back Right Corner) ---------- //
  ...
  DriveCoordShort(111,120,52,0.75);    //Line up with goal
  setIntake(0);   //Stop running intake
  DriveCoordShort(126,136.5,53,1);    //Drive into goal
...
// ---------- Goal 8 (Center) ---------- //
  ...
  DriveCoordShort(100,73,274,0.75);   //Back away
