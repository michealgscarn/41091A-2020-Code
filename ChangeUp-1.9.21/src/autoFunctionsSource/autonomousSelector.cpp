...
static lv_res_t btnm_action(lv_obj_t * btnm, const char *txt) {
  ...
  switch (btnm_num) {
  case 1:
    lv_label_set_text(g_sb_label, "HOME ROW!!! |  Home M & Home L & Home R");
    auton_sel = 1;
    break;
  case 2:
    lv_label_set_text(g_sb_label, "Left 2 Goal | Home Middle & Left Corner");
    auton_sel = 2;
    break;
  case 3:
    lv_label_set_text(g_sb_label, "Left 3 Goal | Home M & Left Corner & Center");
    auton_sel = 3;
break;
  case 4:
    lv_label_set_text(g_sb_label, "Right 1 Goal | Right Corner");
    auton_sel = 4;
break;
  case 5:
    lv_label_set_text(g_sb_label, "Right 2 Goal | Middle & Right Corner");
    auton_sel = 5;
break;
  case 6:
    lv_label_set_text(g_sb_label, "Skills Autonomous");
    auton_sel = 6;
break;
  }
