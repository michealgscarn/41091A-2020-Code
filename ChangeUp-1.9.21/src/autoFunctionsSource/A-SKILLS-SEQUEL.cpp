...
//----------Goal 2 (Left Wall)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(24, 48, 0, 4);   //Move to line up with next ball while spinning to face it
  setIntake(-127);    //Deploy intake
  pros::delay(700);   //Wait for it to deploy
  setIntake(127);   //Run intake forward to pick up a ball
  setLift(127);   //Start running lift
  DriveCoordShort(24,70,0,4);
  DriveCoordShort(24,70,0,4);
  DriveCoordShort(24,70,-90,4);
...
//----------Goal 3 (Back Left Corner)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(34,99,-364,3.75);  //Get In front of Ball
  setIntake(127);
  setLift(127);
  DriveCoordShort(34,122,-360,5); //Pick up ball
  DriveCoordShort(14.5,123.7,-400,5); //Score ball
...
//----------Goal 4 (Back wall)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(49,97.5,-270,3); //Back from goal
  setIntake(127);
  setLift(127);
  DriveCoordShort(69,97,-270,4); //Pick up ball
  DriveCoordShort(69,122,-360,4); //Score ball
...
//----------Goal 5 (Back Right Corner)----------//
  ...
  DriveCoordShort(88,115,-296,1.75); //Drive in front of ball
  setIntake(127);
  setLift(127);
  DriveCoordShort(124,128,-319,4); //Score balls
...
//----------Goal 6 (Right wall)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(118.9,97,-541,4); //Back from goal
  setIntake(127);
  setLift(127);
  DriveCoordShort(118,73,-540,3); //Pick up ball
  DriveCoordShort(113,74,-629,2); //Drive in front of goal
  setIntake(0);
  DriveCoordShort(123,75,-629,2); //Score ball
...
//----------Goal 7 (Center)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(120,74,-541,4); //Back up from goal
  DriveCoordShort(120,74,-450,4); //Pick up ball
  setIntake(127);
  setLift(127);
...
//----------Goal 8 (Front wall)----------//
  //-----Transition to Goal-----//
  DriveCoordShort(90,59,-480,3); //Back from goal
  setIntake(127);   //Start running intake
  setLift(127);   //Start running lift
  DriveCoordShort(75,48,-475,3.25); //Pick up ball
  pros::delay(550);   //Wait for ball to score
  setIntake(0);
  DriveCoordShort(71,22,-540,2.5); //Drive in front of goal
...
//----------Goal 9 (Front Right Corner)----------//
  ...
  DriveCoordShort(90,35,-605,1.5);    //Turn to face ball
  setIntake(127);   //Start running intake to pick up ball
  setLift(127);   //Start running lift
  DriveCoordShort(126.5,18,-586,2.5);    //Drive into goal
...
DriveCoordShort(116.5,28,-586,4);   //Back away from goal
}
